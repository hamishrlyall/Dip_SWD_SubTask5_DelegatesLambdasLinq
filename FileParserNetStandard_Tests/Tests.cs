...
namespace FileParserNetStandard_Tests {
    ...
    public class Tests {
        ...
        private string _csvPath = @"C:\Users\Hamish\source\repos\Dip-Seminar-Delegates-Lambda-Linq_Exercises\data.csv";  // change to appropriate path
        private string _tsvPath = @"C:\Users\Hamish\source\repos\Dip-Seminar-Delegates-Lambda-Linq_Exercises\data.tsv";  // change to appropriate path

        private string _writeFile = "C:/Users/Hamish/source/repos/dataWrite.txt";  // change to appropriate path
